...
const Subscription = () => {
   ...
   *
   * The backend can return ACTIVE, PAUSED, CANCELLED
   * or EXPIRED.
   */
  ...
  /**
   * Handles pause, resume and cancel actions.
   */
  ...
  const openConfirm = (type) => {
    const config = {
      pause: {
        ...
        message:
          'Your service will be suspended until you resume. You won\'t be charged during this period.'
      },

      resume: {
        title: 'Resume Subscription?',
        message:
          'Your service will reactivate immediately and billing will resume.'
      },

      cancel: {
        title: 'Cancel Subscription?',
        message:
          'This will stop all future renewals. Your subscription record will remain in your history.'
      }
    };
  ...
  if (loading) {
    return (
      <div className="max-w-5xl mx-auto space-y-8 animate-pulse">
        <div className="h-10 w-64 bg-main/5 rounded-xl" />

        <div className="h-64 bg-bg-card border border-main rounded-[2.5rem]" />
      </div>
    );
  }
   ...
   *
   * This is different from CANCELLED or EXPIRED.
   */
  if (!subscription) {
    return (
      <div className="max-w-5xl mx-auto py-20">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-tr from-primary-violet/5 to-transparent" />

          <div className="relative z-10">
            <Sparkles className="h-20 w-20 text-primary-violet/20 mx-auto mb-6" />

            <h3 className="text-3xl font-black text-main mb-4 tracking-tighter">
              No subscription
            </h3>
  ...
  const StatusIcon =
    statusIcons[subscription.status] || AlertCircle;
  ...
  /**
   * Displays an appropriate message based on subscription status.
   */
  const getStatusMessage = () => {
    switch (subscription.status) {
      ...
      case 'PAUSED':
        return 'Your subscription is paused. Resume it whenever you are ready.';

      case 'CANCELLED':
        return 'Your subscription has been cancelled and will not renew.';

      case 'EXPIRED':
        return 'Your subscription has expired. Choose a plan to continue.';
      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-muted mt-1">
            Manage your plan, billing, and status.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-bg-card border border-main rounded-[2.5rem] p-8 md:p-10 shadow-xl relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-64 h-64 bg-primary-violet/5 rounded-full blur-[80px] -mr-32 -mt-32" />
            ...
            <div className="relative z-10">
              ...
              <div className="flex justify-between items-start mb-10">
                ...
                <div>
                  ...
                  <span
                    className={`px-4 py-1.5 rounded-full text-[10px] font-black border tracking-widest uppercase ${
                      statusColors[
                        subscription.status
          ...
          <div className="bg-bg-card border border-main rounded-[2.5rem] p-8 shadow-xl">
            ...
            <h4 className="text-xl font-black text-main mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {subscription.status === 'ACTIVE' && (
                <>
                  ...
                  <button
                    ...
                    disabled={actionLoading}
                    className="flex items-center justify-between p-6 bg-accent-orange/5 border border-accent-orange/20 rounded-2xl group hover:bg-accent-orange/10 transition-all disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    disabled={actionLoading}
                    className="flex items-center justify-between p-6 bg-red-500/5 border border-red-500/20 rounded-2xl group hover:bg-red-500/10 transition-all md:col-span-2 disabled:opacity-50"
                  >
                    <div className="flex items-center gap-4">
              ...
              {subscription.status === 'PAUSED' && (
                <>
                  ...
                  <button
                    ...
                    disabled={actionLoading}
                    className="flex items-center justify-between p-6 bg-accent-lime/5 border border-accent-lime/20 rounded-2xl group hover:bg-accent-lime/10 transition-all disabled:opacity-50"
                  >
                    <div className="flex items-center gap-4">
                  ...
                  <button
                    ...
                    disabled={actionLoading}
                    className="flex items-center justify-between p-6 bg-red-500/5 border border-red-500/20 rounded-2xl group hover:bg-red-500/10 transition-all disabled:opacity-50"
                  >
                    <div className="flex items-center gap-4">
              ...
              {subscription.status === 'CANCELLED' && (
                <>
                  <div className="md:col-span-2 p-6 rounded-2xl bg-red-500/5 border border-red-500/20">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h5 className="font-black text-main">
                          Subscription Cancelled
                        </h5>

                        <p className="text-sm text-muted mt-1">
                          This subscription will not renew.
                          Your subscription history remains available.
                        </p>
                      </div>
                  ...
                  <Link
                    to="/plans"
                    className="md:col-span-2 flex items-center justify-center gap-3 p-5 bg-primary-violet text-white rounded-2xl font-black hover:bg-primary-purple transition-all"
                  >
              ...
              {subscription.status === 'EXPIRED' && (
                <>
                  <div className="md:col-span-2 p-6 rounded-2xl bg-main/5 border border-main/10">

                    <div className="flex items-start gap-4">

                      <div className="w-12 h-12 bg-main/5 rounded-xl flex items-center justify-center flex-shrink-0">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted mt-1">
                          ...
                          Choose a plan to continue using Subly.
                        </p>
                      </div>
