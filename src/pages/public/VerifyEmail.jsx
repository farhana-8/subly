...
const VerifyEmail = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-4 bg-bg-deep relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary-violet/5 rounded-full blur-[120px] pointer-events-none">
      </div>
        ...
        <div className="bg-bg-card border border-main rounded-[2rem] p-8 md:p-10 shadow-2xl backdrop-blur-xl text-center">
          ...
          {status === 'success' && (
            ...
            <div className="py-10">
              ...
              <h2 className="text-3xl font-black text-main mb-4">
                Email Verified!
              </h2>
          ...
          {status === 'error' && (
            ...
            <div className="py-10">
              ...
              <div className="space-y-4">
                ...
                <Link
                  to="/login"
                  className="block text-primary-violet font-black hover:underline"
                >
                  Back to Login
                </Link>
