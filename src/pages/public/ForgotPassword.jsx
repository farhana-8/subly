...
import { Layout, ArrowRight, Mail, AlertCircle, CheckCircle2 } from 'lucide-react';
      ...
      >
        <div className="bg-bg-card border border-main rounded-[2rem] p-8 md:p-10 shadow-2xl backdrop-blur-xl">
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-black text-main">Reset Password</h2>
          ...
          {isSuccess ? (
            <div className="text-center py-6">
              ...
              <h3 className="text-xl font-black text-main mb-2">Check your email</h3>
              <p className="text-muted mb-8 leading-relaxed">
                We've sent a password reset link to <span className="text-main font-bold">{email}</span>.
              </p>
              <Link 
                to="/login" 
                className="inline-flex items-center text-primary-violet font-black hover:underline gap-2"
              >
                Return to Login
